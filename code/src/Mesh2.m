classdef Mesh2
    ...
    methods
        ...
        function obj = setAssMatrix(obj, n)
            if n ==3
...
%                     end
        ...
        function obj = L(obj, n, M, BNegBpos)
           if n == 3
        ...
        function obj = L2(obj, M, BNegBPos)
            ...
            obj = obj.getIMEXPotential;
            H{1} = obj.H;
            obj.coeffs = obj.assMatrix \ (M*c{1} + gamma * obj.t*H{1});
            c{2} = obj.coeffs;
