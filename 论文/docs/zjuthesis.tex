...
\documentclass[
    ...
    % Thesis Info
    StudentName     = 鲁硕,
    StudentID       = 3200101874,
    AdvisorName     = 仲杏慧,
    Grade           = 2020,            % only the year, no '级'
    Major           = 信息与计算科学,
    Department      = 数学科学学院,
    SubmitDate      = 2024年5月20日,
    MajorFormat     = math,         % 'general', 'cs', 'ee', 'isee', 'math', 'opteng', 'physics', 'se'
    ...
    % Title
    Title           = 局部间断Galerkin方法的算法设计与应用,
    TitleEng        = {{Algorithm Design and Application of the Local Discontinuous Galerkin Method}}
]{zjuthesis}
